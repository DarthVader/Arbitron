...
/*
 ...
 commit tran
 --
 select * from mem.order_book where id_ex_pair=212 -- mem table
 select * from dbo.order_book where id_ex_pair=212 -- disk history table
...
*/
	...
	begin tran 
		...
		*/
		...
		where mem.order_book.id_ex_pair = (select id_ex_pair from #tmp)
